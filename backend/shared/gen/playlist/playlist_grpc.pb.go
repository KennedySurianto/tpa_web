...
func (c *playlistServiceClient) GetPlaylistsByUserId(ctx context.Context, in *GetPlaylistRequest, opts ...grpc.CallOption) (*GetPlaylistByUserIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPlaylistByUserIdResponse)
	err := c.cc.Invoke(ctx, PlaylistService_GetPlaylistsByUserId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPlaylistServiceServer) GetPlaylistsByUserId(context.Context, *GetPlaylistRequest) (*GetPlaylistByUserIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPlaylistsByUserId not implemented")
}
...
func _PlaylistService_GetPlaylistsByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPlaylistRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlaylistServiceServer).GetPlaylistsByUserId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PlaylistService_GetPlaylistsByUserId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlaylistServiceServer).GetPlaylistsByUserId(ctx, req.(*GetPlaylistRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PlaylistService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PlaylistService_GetPlaylistsByUserId_Handler,
		},
		{
