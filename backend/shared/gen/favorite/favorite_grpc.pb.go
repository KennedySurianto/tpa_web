...
const (
	...
	FavoriteService_RemoveFavorite_FullMethodName            = "/favorite.FavoriteService/RemoveFavorite"
	FavoriteService_GetFavoriteVideosByUserId_FullMethodName = "/favorite.FavoriteService/GetFavoriteVideosByUserId"
	FavoriteService_IsFavorited_FullMethodName               = "/favorite.FavoriteService/IsFavorited"
)
...
type FavoriteServiceClient interface {
	...
	GetFavoriteVideosByUserId(ctx context.Context, in *GetFavoriteVideosByUserIdRequest, opts ...grpc.CallOption) (*GetFavoriteVideosByUserIdResponse, error)
...
func (c *favoriteServiceClient) GetFavoriteVideosByUserId(ctx context.Context, in *GetFavoriteVideosByUserIdRequest, opts ...grpc.CallOption) (*GetFavoriteVideosByUserIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetFavoriteVideosByUserIdResponse)
	err := c.cc.Invoke(ctx, FavoriteService_GetFavoriteVideosByUserId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FavoriteServiceServer interface {
	...
	GetFavoriteVideosByUserId(context.Context, *GetFavoriteVideosByUserIdRequest) (*GetFavoriteVideosByUserIdResponse, error)
...
func (UnimplementedFavoriteServiceServer) GetFavoriteVideosByUserId(context.Context, *GetFavoriteVideosByUserIdRequest) (*GetFavoriteVideosByUserIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFavoriteVideosByUserId not implemented")
}
...
func _FavoriteService_GetFavoriteVideosByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFavoriteVideosByUserIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FavoriteServiceServer).GetFavoriteVideosByUserId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FavoriteService_GetFavoriteVideosByUserId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FavoriteServiceServer).GetFavoriteVideosByUserId(ctx, req.(*GetFavoriteVideosByUserIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FavoriteService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FavoriteService_GetFavoriteVideosByUserId_Handler,
		},
		{
