...
const (
	...
	NotificationService_SendNotificationToUser_FullMethodName = "/notification.NotificationService/SendNotificationToUser"
)
...
type NotificationServiceClient interface {
	...
	SendNotificationToUser(ctx context.Context, in *SendNotificationToUserRequest, opts ...grpc.CallOption) (*SendNotificationResponse, error)
}
...
func (c *notificationServiceClient) SendNotificationToUser(ctx context.Context, in *SendNotificationToUserRequest, opts ...grpc.CallOption) (*SendNotificationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendNotificationResponse)
	err := c.cc.Invoke(ctx, NotificationService_SendNotificationToUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NotificationServiceServer interface {
	...
	SendNotificationToUser(context.Context, *SendNotificationToUserRequest) (*SendNotificationResponse, error)
...
func (UnimplementedNotificationServiceServer) SendNotificationToUser(context.Context, *SendNotificationToUserRequest) (*SendNotificationResponse, error) {
...
func _NotificationService_SendNotificationToUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendNotificationToUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_SendNotificationToUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).SendNotificationToUser(ctx, req.(*SendNotificationToUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
