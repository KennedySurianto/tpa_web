...
const file_like_proto_rawDesc = "" +
	...
	"\x05liked\x18\x01 \x01(\bR\x05liked2\xc1\x01\n" +
	"\vLikeService\x125\n" +
	...
	"\aIsLiked\x12\x18.activity.IsLikedRequest\x1a\x19.activity.IsLikedResponseBAZ?github.com/KennedySurianto/tpa_web/backend/shared/gen/like;likeb\x06proto3"
...
var file_like_proto_depIdxs = []int32{
	...
	1, // 3: activity.LikeService.Like:output_type -> activity.LikeResponse
	3, // 4: activity.LikeService.Unlike:output_type -> activity.UnlikeResponse
	5, // 5: activity.LikeService.IsLiked:output_type -> activity.IsLikedResponse
