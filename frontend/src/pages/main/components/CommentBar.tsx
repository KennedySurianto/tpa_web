  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span>Comments {canComment ? `(${comments.length})` : ''}</span>
      ...
      {!canComment ? (
        ...
        <div style={{
          ...
          <h3 style={{ 
            ...
            Comments are not allowed in this video
          </h3>
          <p style={{ 
            margin: 0, 
            fontSize: '14px',
        ...
        // Comments enabled - show normal content
        <div style={{
          flexGrow: 1,
          display: 'flex',
          flexDirection: 'column',
          ...
          {/* Input Box - Only show when comments are enabled */}
          <div style={{
            padding: '12px 16px',
            backgroundColor: '#161823',
